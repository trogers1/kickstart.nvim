...
-- Keep indentation width compact and consistent
vim.opt.tabstop = 2
...
vim.keymap.set('n', '<leader>ge', vim.diagnostic.open_float, { desc = '[G]oTo diagnostic/[e]rror popup' })
      ...
      require('mason-lspconfig').setup {
        handlers = {
          function(server_name)
            ...
            -- certain features of an LSP (for example, turning off formatting for ts_ls (prev: tsserver)
